     ...
     return(
       ...
       <div>
          ...
          <section id="safety">
            <div className="container p-5">
              <div className="row justify-content-center">
                <h3 className="text-center font-weight-bolder">Safety in the Spotlight</h3>
              </div>
              <div className="row justify-content-center">
                <h6 className="text-center light-text font-weight-normal">Hygienic &amp; Single-use products | Low-contact
                  services</h6>
              </div>
              <div className="row justify-content-center mt-4">
                <div className="col-6 col-md-3">
                  <img src={sanitizer} alt="Image" className="img-fluid" />
                  <h5 className="text-center mt-3 font-weight-bold">Sanitized Hands </h5>
                  <p className="text-center lighter-text">At Your Service</p>
                </div>
                <div className="col-6 col-md-3">
                  <img src={temperature} alt="Image" className="img-fluid" />
                  <h5 className="text-center mt-3 font-weight-bold">Temparature Checks </h5>
          ...
          <section id="services">
            <div className="container p-5">
              <div className="row justify-content-center">
                <h3 className="text-center font-weight-bolder"> Services That Your Home Deserve💙</h3>
              </div>
              <div className="row justify-content-center">
                <h6 className="text-center light-text font-weight-normal">Expert Service Providers at your doorstep 
                </h6>
              </div>
              <div className="row justify-content-center mt-4">
                <div className="col-15 col-md-3">
                  <img src={clean} alt="Image" className="img-fluid" />
                  <p className="text-center mt-3">Cleaning</p>
                  
                </div>
                <div className="col-15 col-md-3">
                  <img src={cook} alt="Image" className="img-fluid" />
                  <p className="text-center mt-3">Cooking</p>
                </div>
                <div className="col-15 col-md-3">
                  <img src={plumber} alt="Image" className="img-fluid" />
                  <p className="text-center mt-3">Plumbing</p>
                </div>
                <div className="col-15 col-md-3">
                  <img src={electrician} alt="Image" className="img-fluid" />
                  <p className="text-center mt-3">Electrical Maintence</p>
                </div>
                <div className="col-15 col-md-3">
                  <img src={househelp} alt="Image" className="img-fluid" />
                  <p className="text-center mt-3">HouseHelp</p>
                </div>
              </div>
            </div>
          </section>
            ...
            <div className="container" style={{overflowX: 'hidden'}}>
              <div className="row">
                <div className="col-12 col-md-12">
                  <img src={logo} className="img-fluid" alt="Urban Services" style={{width: '250px'}} />
                  <p className="text-justify mt-3">Lorem Ipsum. Proin gravida
                ...
                <div className="col-12 col-md-3">
                  ...
                  <ul className="footer-links">
                    <li>Lorem Ipsum. Proin gravida
                      nibh vel velit auctor aliquet. Mumbai-400001.</li>
                    <li><b>Phone: </b><a href="tel:9876543210">9876543210</a></li>
                    <li><b>Email: </b><a href="mailto:support@urbanclap.com">support@urbanservices.com</a></li>
                  </ul>
                </div>
              </div>
              <hr />
            ...
            <div className="container">
              <div className="row">
                <div className="col-md-8 col-sm-6 col-xs-12">
                  <p className="copyright-text">© Copyright 2021 | Urban Services | All right reserved.
                  </p>
                </div>
