          ...
          <div className="row">
            ...
            <div className="col">
              ...
              <div className="card bg-dark text-white">
                ...
                <div className="card-body">
                  ...
                  <form action="login" className="was-validated">
                    ...
                    <div className="form-group">
                      ...
                      <input type="text" className="form-control" id="pcode" placeholder="Your Expertise" name="pcode" required />
                    </div>
                    </div>
                ...
                <div><button type="button" className="btn btn-primary btn-block" onClick={()=>history.push('/comments')}>Register</button></div>
